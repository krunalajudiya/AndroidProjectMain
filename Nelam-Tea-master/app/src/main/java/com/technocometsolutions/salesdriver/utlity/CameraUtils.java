...
import com.technocometsolutions.salesdriver.activity.SaveexActivity;
...
public class CameraUtils {
    ...
    public static File getOutputMediaFile(int type) {
        ...
        File mediaStorageDir = new File(
                ...
                SaveexActivity.GALLERY_DIRECTORY_NAME);
        ...
        if (!mediaStorageDir.exists()) {
            if (!mediaStorageDir.mkdirs()) {
                ...
                Log.e(SaveexActivity.GALLERY_DIRECTORY_NAME, "Oops! Failed create "
                        + SaveexActivity.GALLERY_DIRECTORY_NAME + " directory");
        ...
        File mediaFile;
        if (type == SaveexActivity.MEDIA_TYPE_IMAGE) {
            mediaFile = new File(mediaStorageDir.getPath() + File.separator
                    + "IMG_" + timeStamp + "." + SaveexActivity.IMAGE_EXTENSION);
        }  else {
            return null;
        }
