...
public class DownloadCatalouge {
    ...
    public DownloadCatalouge(Activity context, String downloadUrl) {
        ...
        new DownloadCatalouge.DownloadingCatalouge().execute();
    }
        ...
        protected void onPostExecute(Void result) {
            try {
                if (outputFile != null) {
                    ...
                    Toast.makeText(context,""+ Environment.getExternalStorageDirectory() + "/Download/" + downloadFileName,Toast.LENGTH_LONG).show();
