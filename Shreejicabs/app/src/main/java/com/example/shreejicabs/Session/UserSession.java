package com.example.shreejicabs.Session;
...
public class UserSession {
    ...
    public void settoken(boolean isFirstTime) {
        editor.putBoolean(IS_TOKEN, isFirstTime);
        editor.commit();
    }
    public boolean gettoken() {
        return pref.getBoolean(IS_TOKEN, false);
    }
